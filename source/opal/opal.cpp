...
const int SIMD_REG_SIZE = 128; //!< number of bits in register
typedef int8x16_t __mxxxi; //!< represents register containing integers

static inline __mxxxi neon_load_si(const __mxxxi* p) {
    return vld1q_s8(reinterpret_cast<const int8_t*>(p));
}

static inline void neon_store_si(__mxxxi* p, const __mxxxi& a) {
    vst1q_s8(reinterpret_cast<int8_t*>(p), a);
}

static inline __mxxxi neon_and_si(const __mxxxi& a, const __mxxxi& b) {
    return vandq_s8(a, b);
}

static inline int neon_testz_si(const __mxxxi& a, const __mxxxi& b) {
    uint8x16_t ab = vandq_u8(vreinterpretq_u8_s8(a), vreinterpretq_u8_s8(b));
    uint64x2_t ab64 = vreinterpretq_u64_u8(ab);
    return (vgetq_lane_u64(ab64, 0) | vgetq_lane_u64(ab64, 1)) == 0;
}

static inline __mxxxi neon_adds_epi8(const __mxxxi& a, const __mxxxi& b) {
    return vqaddq_s8(a, b);
}

static inline __mxxxi neon_subs_epi8(const __mxxxi& a, const __mxxxi& b) {
    return vqsubq_s8(a, b);
}

static inline __mxxxi neon_min_epu8(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_u8(vminq_u8(vreinterpretq_u8_s8(a), vreinterpretq_u8_s8(b)));
}

static inline __mxxxi neon_min_epi8(const __mxxxi& a, const __mxxxi& b) {
    return vminq_s8(a, b);
}

static inline __mxxxi neon_max_epu8(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_u8(vmaxq_u8(vreinterpretq_u8_s8(a), vreinterpretq_u8_s8(b)));
}

static inline __mxxxi neon_max_epi8(const __mxxxi& a, const __mxxxi& b) {
    return vmaxq_s8(a, b);
}

static inline __mxxxi neon_set1_epi8(int a) {
    return vdupq_n_s8(static_cast<int8_t>(a));
}

static inline __mxxxi neon_cmpgt_epi8(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_u8(vcgtq_s8(a, b));
}

static inline __mxxxi neon_adds_epi16(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_s16(vqaddq_s16(vreinterpretq_s16_s8(a), vreinterpretq_s16_s8(b)));
}

static inline __mxxxi neon_subs_epi16(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_s16(vqsubq_s16(vreinterpretq_s16_s8(a), vreinterpretq_s16_s8(b)));
}

static inline __mxxxi neon_min_epi16(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_s16(vminq_s16(vreinterpretq_s16_s8(a), vreinterpretq_s16_s8(b)));
}

static inline __mxxxi neon_max_epi16(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_s16(vmaxq_s16(vreinterpretq_s16_s8(a), vreinterpretq_s16_s8(b)));
}

static inline __mxxxi neon_set1_epi16(int a) {
    return vreinterpretq_s8_s16(vdupq_n_s16(static_cast<int16_t>(a)));
}

static inline __mxxxi neon_cmpgt_epi16(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_u16(vcgtq_s16(vreinterpretq_s16_s8(a), vreinterpretq_s16_s8(b)));
}

static inline __mxxxi neon_add_epi32(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_s32(vaddq_s32(vreinterpretq_s32_s8(a), vreinterpretq_s32_s8(b)));
}

static inline __mxxxi neon_sub_epi32(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_s32(vsubq_s32(vreinterpretq_s32_s8(a), vreinterpretq_s32_s8(b)));
}

static inline __mxxxi neon_min_epi32(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_s32(vminq_s32(vreinterpretq_s32_s8(a), vreinterpretq_s32_s8(b)));
}

static inline __mxxxi neon_max_epi32(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_s32(vmaxq_s32(vreinterpretq_s32_s8(a), vreinterpretq_s32_s8(b)));
}

static inline __mxxxi neon_set1_epi32(int a) {
    return vreinterpretq_s8_s32(vdupq_n_s32(static_cast<int32_t>(a)));
}

static inline __mxxxi neon_cmpgt_epi32(const __mxxxi& a, const __mxxxi& b) {
    return vreinterpretq_s8_u32(vcgtq_s32(vreinterpretq_s32_s8(a), vreinterpretq_s32_s8(b)));
}

#define _mmxxx_load_si  neon_load_si
#define _mmxxx_store_si neon_store_si
#define _mmxxx_and_si   neon_and_si
#define _mmxxx_testz_si neon_testz_si

#define _mmxxx_adds_epi8  neon_adds_epi8
#define _mmxxx_subs_epi8  neon_subs_epi8
#define _mmxxx_min_epu8   neon_min_epu8
#define _mmxxx_min_epi8   neon_min_epi8
#define _mmxxx_max_epu8   neon_max_epu8
#define _mmxxx_max_epi8   neon_max_epi8
#define _mmxxx_set1_epi8  neon_set1_epi8
#define _mmxxx_cmpgt_epi8 neon_cmpgt_epi8

#define _mmxxx_adds_epi16  neon_adds_epi16
#define _mmxxx_subs_epi16  neon_subs_epi16
#define _mmxxx_min_epi16   neon_min_epi16
#define _mmxxx_max_epi16   neon_max_epi16
#define _mmxxx_set1_epi16  neon_set1_epi16
#define _mmxxx_cmpgt_epi16 neon_cmpgt_epi16

#define _mmxxx_add_epi32   neon_add_epi32
#define _mmxxx_sub_epi32   neon_sub_epi32
#define _mmxxx_min_epi32   neon_min_epi32
#define _mmxxx_max_epi32   neon_max_epi32
#define _mmxxx_set1_epi32  neon_set1_epi32
#define _mmxxx_cmpgt_epi32 neon_cmpgt_epi32
...
// #ifdef __AVX2__
#else     //A.D.: now SIMDe will be taking care of the SIMD
